...
test_cases <- list(
  ...
  list(name = "Flatten nested", code = "[1 [2 3] [4 [5]]] aL", expected = "1 2 3 4 5"),
  list(name = "Flatten single", code = "[1 2 3] aL", expected = "1 2 3"),
  ...
  list(name = "Reverse string", code = "'hello' Sr", expected = "olleh"),
  list(name = "Reverse empty", code = "'' Sr", expected = ""),
  list(name = "Cumulative product", code = "[1 2 3 4 5] aP", expected = "1 2 6 24 120"),
  list(name = "Unique count", code = "[1 2 2 3 3 3] aQ", expected = "3"),
  list(name = "Index of found", code = "30 [10 20 30 40] aM", expected = "3"),
  list(name = "Index of not found", code = "99 [10 20 30] aM", expected = "NA"),
  ...
  list(name = "Sqrt", code = "9 mQ", expected = "3"),
  list(name = "Map short", code = "[1 2 3] {2*} q", expected = "2 4 6"),
  list(name = "Filter short", code = "[1 2 3 4] {2 % 0 =} Ft", expected = "2 4"),
  list(name = "Reduce short", code = "[1 2 3 4 5] {+} y", expected = "15"),
  list(name = "Head 1", code = "[1 2 3] 1 ah", expected = "1"),
